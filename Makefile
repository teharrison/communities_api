...
RPACKAGES = Cairo_1.5-1.tar.gz ecodist_1.2.5.tar.gz RJSONIO_0.98-1.tar.gz matlab_0.8.9.tar.gz gtools_2.6.2.tar.gz gdata_2.8.2.tar.gz bitops_1.0-4.1.tar.gz caTools_1.12.tar.gz gplots_2.10.1.tar.gz
