...
sub help {
  my $text = qq~
NAME
    can_get_sample_query.pl -- retrieve a list of samples from the communities API

VERSION
    2

SYNOPSIS
    can_get_sample_query.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>##optionlist##]
