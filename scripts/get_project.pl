...
sub usage {
  print "get_project.pl >>> retrieve a project from the communities API\n";
  print "get_project.pl -id <id of the project>\n"; 
}

sub help {
  my $text = qq~get_project
...
my $HOST      = 'http://www.kbase.us/services/communities/project/';
my $id        = '';
my $user      = '';
my $pass      = '';
my $token     = '';
