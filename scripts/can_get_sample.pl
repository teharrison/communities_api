...
sub help {
  my $text = qq~
NAME
    can_get_sample.pl -- retrieve a sample from the communities API

VERSION
    2

SYNOPSIS
    can_get_sample.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level> --id <sample id>]
