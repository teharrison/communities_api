...
sub help {
  my $text = qq~
NAME
    can-get-sample-query.pl -- retrieve a list of samples from the communities API

VERSION
    2

SYNOPSIS
    can-get-sample-query.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>##optionlist##]
