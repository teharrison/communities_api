...
sub help {
  my $text = qq~
NAME
    can-get-sequenceset.pl -- retrieve a sequenceset from the communities API

VERSION
    2

SYNOPSIS
    can-get-sequenceset.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level> --id <sequenceset id>]
