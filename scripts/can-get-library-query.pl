...
sub help {
  my $text = qq~
NAME
    can-get-library-query.pl -- retrieve a list of libraries from the communities API

VERSION
    2

SYNOPSIS
    can-get-library-query.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>##optionlist##]
