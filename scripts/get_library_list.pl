...
sub usage {
  print "get_library_list.pl >>> retrieve a list of librarys from the communities API\n";
  print "get_library_list.pl -id <id of the library>\n"; 
}

sub help {
  my $text = qq~get_library_list
...
my $HOST      = 'http://www.kbase.us/services/communities/library/';
my $user      = '';
my $pass      = '';
my $token     = '';
my $verbosity = 'full';
