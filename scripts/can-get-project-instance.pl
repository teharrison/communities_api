...
sub help {
  my $text = qq~
NAME
    can-get-project-instance.pl -- retrieve a project from the communities API

VERSION
    2

SYNOPSIS
    can-get-project-instance.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level> --id <project id>]
