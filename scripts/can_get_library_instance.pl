...
sub help {
  my $text = qq~
NAME
    can_get_library_instance.pl -- retrieve a library from the communities API

VERSION
    2

SYNOPSIS
    can_get_library_instance.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level> --id <library id>]
