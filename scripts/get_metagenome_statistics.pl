...
sub usage {
  print "get_metagenome_statistics.pl >>> retrieve a metagenome_statistics from the communities API\n";
  print "get_metagenome_statistics.pl -id <id of the metagenome_statistics>\n"; 
}

sub help {
  my $text = qq~get_metagenome_statistics
...
my $HOST      = 'http://www.kbase.us/services/communities/metagenome_statistics/';
my $id        = '';
my $user      = '';
my $pass      = '';
my $token     = '';
