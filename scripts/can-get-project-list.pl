...
sub help {
  my $text = qq~
NAME
    can-get-project-list.pl -- retrieve a list of projects from the communities API

VERSION
    2

SYNOPSIS
    can-get-project-list.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>##optionlist##]
