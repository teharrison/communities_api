...
sub help {
  my $text = qq~
NAME
    can_get_metagenome.pl -- retrieve a metagenome from the communities API

VERSION
    2

SYNOPSIS
    can_get_metagenome.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level> --id <metagenome id>]
