...
sub help {
  my $text = qq~
NAME
    can-get-metagenome-query.pl -- retrieve a list of metagenomes from the communities API

VERSION
    2

SYNOPSIS
    can-get-metagenome-query.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>##optionlist##]
