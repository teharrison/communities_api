...
class CommunitiesAPI:
    ...
    def get_analysisset_instance(self, get_analysisset_instance_params):

        arg_hash = { 'method': 'CommunitiesAPI.get_analysisset_instance',
                     'params': [get_analysisset_instance_params],
                     'version': '1.1'
                     }
    ...
    def get_analysisset_setlist(self, get_analysisset_setlist_params):

        arg_hash = { 'method': 'CommunitiesAPI.get_analysisset_setlist',
                     'params': [get_analysisset_setlist_params],
                     'version': '1.1'
                     }
    ...
    def get_matrix_organism(self, get_matrix_organism_params):

        arg_hash = { 'method': 'CommunitiesAPI.get_matrix_organism',
                     'params': [get_matrix_organism_params],
                     'version': '1.1'
                     }
    ...
    def get_matrix_function(self, get_matrix_function_params):

        arg_hash = { 'method': 'CommunitiesAPI.get_matrix_function',
                     'params': [get_matrix_function_params],
                     'version': '1.1'
                     }
    ...
    def get_metagenome_statistics_instance(self, get_metagenome_statistics_instance_params):

        arg_hash = { 'method': 'CommunitiesAPI.get_metagenome_statistics_instance',
                     'params': [get_metagenome_statistics_instance_params],
                     'version': '1.1'
                     }
