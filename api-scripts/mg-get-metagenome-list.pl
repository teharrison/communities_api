...
sub help {
  my $text = qq~
NAME
    mg-get-metagenome-list.pl -- retrieve a list of metagenomes from the communities API

VERSION
    2

SYNOPSIS
    mg-get-metagenome-list.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>]
