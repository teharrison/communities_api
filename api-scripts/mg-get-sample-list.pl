...
sub help {
  my $text = qq~
NAME
    mg-get-sample-list.pl -- retrieve a list of samples from the communities API

VERSION
    2

SYNOPSIS
    mg-get-sample-list.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>]
