...
sub help {
  my $text = qq~
NAME
    mg-get-project.pl -- retrieve a project from the communities API

VERSION
    2

SYNOPSIS
    mg-get-project.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>--id <project id>]
