...
sub help {
  my $text = qq~
NAME
    mg-download-stage-file-list.pl -- download a communities API pipeline result file

VERSION
    2

SYNOPSIS
    mg-download-stage-file-list.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>--id <metagenome id>, --stage <stage id>]

DESCRIPTION
    download the list of intermediate and resulting file produced by a specified stage of the communities API analysis pipeline for a specified metagenome
