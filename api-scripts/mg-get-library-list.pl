...
sub help {
  my $text = qq~
NAME
    mg-get-library-list.pl -- retrieve a list of libraries from the communities API

VERSION
    2

SYNOPSIS
    mg-get-library-list.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>]
