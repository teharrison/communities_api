...
sub help {
  my $text = qq~
NAME
    mg-get-project-list.pl -- retrieve a list of projects from the communities API

VERSION
    2

SYNOPSIS
    mg-get-project-list.pl [ --help, --user <user>, --pass <password>, --token <oAuth token>, --webkey <communities webkey>, --verbosity <verbosity level>]
...
my $HOST      = 'http://kbase.us/services/communities/1/project/';
my $user      = '';
my $pass      = '';
my $token     = '';
my $verbosity = 'full';
