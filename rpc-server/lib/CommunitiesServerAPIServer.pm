package CommunitiesServerAPIServer;
...
sub call_method {
	...
	$data->{arguments} = $actual_args;
        ...
        # Module CommunitiesServerAPI does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in module CommunitiesServerAPI.");
    }
